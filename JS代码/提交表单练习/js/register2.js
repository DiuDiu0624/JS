...
function checkForm() {
    ...
    function checkname() {
        var a = /^[0-9a-zA-Z][0-9a-zA-Z]{0,}$/;
      if (!a.test(oname.value)) {
    ...
    function checkpwd() {
       var a  = /^[0-9a-zA-Z][0-9a-zA-Z]{6,}$/;
        if (opwd.value === '') {
            otips[1].innerHTML = "密码不能为空";
            otips[1].style.display = "block";
        } else if (!a.test(opwd.value)) {
    ...
    function checkemail() {
        var a = /^[0-9a-zA-Z]+@[0-9a-zA-Z]+\.[0-9a-zA-Z]+$/;
        if (oemail.value === '') {
            otips[3].innerHTML = "邮箱不能为空";
            otips[3].style.display = "block";
        } else if (!a.test(oemail.value)) {
